...
new_class = """class IsraelRoadTSPVisualizer(tk.Frame):
    MAP_W = 373
    MAP_H = 512
...
start_token = "class IsraelRoadTSPVisualizer(tk.Frame):"
end_token = "class MainApp(tk.Tk):"

start_idx = content.find(start_token)
end_idx = content.find(end_token)

if start_idx == -1 or end_idx == -1:
    print(f"Error: tokens not found! start_idx: {start_idx}, end_idx: {end_idx}")
    exit(1)
...
print("Programmatic replacement completed successfully!")
